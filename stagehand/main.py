...
class Stagehand:
    ...
    def __init__(
        ...
        **config_overrides,
        ...
        self.model_api_base = self.config.model_api_base
        ...
        if self.config.model_api_base:
            self.model_client_options["api_base"] = self.config.model_api_base

        # Allow additional model_client_options from config overrides
        if "model_client_options" in config_overrides:
            self.model_client_options.update(config_overrides["model_client_options"])
