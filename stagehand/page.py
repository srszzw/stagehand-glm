...
class StagehandPage:
    ...
    async def act(
        self,
        action_or_result: Union[str, ObserveResult, dict],
        use_cache: bool = False,
        cache_ttl: int = 3600 * 24 * 365,
        **kwargs,
    ) -> ActResult:
        """
        ...
        Args:
            ...
            use_cache (bool): Whether to use caching mechanism to avoid redundant LLM calls.
        ...
        if not self._stagehand.use_api:
            ...
            result = await self._act_handler.act(
                payload, use_cache=use_cache, cache_ttl=cache_ttl
            )
            return result
